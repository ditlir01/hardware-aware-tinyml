...
# Same architecture as MNIST M0+ variant; Fashion-MNIST is harder so
# accuracy will land a bit lower (~85-87% vs MNIST's 96%).
...
model.save("fmnist_mlp_m0.keras")
print("Saved -> fmnist_mlp_m0.keras")
