# Neuro-C Fashion-MNIST sized for NUCLEO-F072RB / MSPM0G3507 (128 KB Flash).
# Architecture: 784 -> 64 -> 32 -> 10  (2 hidden Neuro-C layers).
# Same architecture as mnist_neuroc_nucleo.py for direct cross-dataset comparison.
...
model.save("fmnist_neuroc_nucleo.keras")
print("Saved -> fmnist_neuroc_nucleo.keras")
