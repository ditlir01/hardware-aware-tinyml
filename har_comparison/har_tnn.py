...
print(f"Note          : the literal TNN is unstable across seeds (FMNIST sigma=3.5).")
print(f"                Run the multi-seed ablation for a mean+-std report.")
