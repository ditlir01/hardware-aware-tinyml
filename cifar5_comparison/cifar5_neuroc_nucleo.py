# Neuro-C CIFAR-5 sized for NUCLEO-F072RB / MSPM0G3507 (128 KB Flash).
# Architecture: 3072 -> 64 -> 32 -> 5  (2 hidden Neuro-C layers).
...
model.save("cifar5_neuroc_nucleo.keras")
print("Saved -> cifar5_neuroc_nucleo.keras")
